...
OFFICIAL_UPSTREAM_REPO = "https://github.com/its-leo-bitch/LEO-BITCH-USERBOT/"
BOT_IS_UP_TO_DATE = "Leo Bitch userbot is up-to-date!."
NEW_BOT_UP_DATE_FOUND = (
    "**Leo Bitch userbot update Found For** {branch_name}\n"
    "\n\n{changelog}\n"
    "Pulling Updates !!"
)
NEW_UP_DATE_FOUND = (
...
async def deploy_start(bot, message, refspec, remote):
    ...
    await message.edit("The Latest Branch** `Master` **Has Been Pushed To Heroku** \n**Now Trying A Restart To Complete Updation Process ⚠️ !!** To Check If I am Alive Just Do `.alive` or `.help` !!!! ThankYou For Using Leo Bitch Userbot Service (◍•ᴗ•◍)❤")
